...
void main()
{
	...
	const float DISTORTION_SCALE_MULT 		= 10.0;
	const float DISTORTION_SCALE_MULT2 		= 0.0005;
	...
	const vec4  FOG_FOREGROUND 				= vec4(0.6,0.6,0.6,0.5);
