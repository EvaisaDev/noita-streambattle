...
RegisterSpawnFunction( 0xff00ffe1, "create_spawnpoint" )
...
function spawn_items( pos_x, pos_y )
	if(GlobalsGetValue("streambattle_items", "true") == "true")then
...
function spawn_small_enemies(x, y)
	...
	if(GlobalsGetValue("streambattle_enemies", "true") == "true")then
...
function spawn_lamp(x, y)
	if(GlobalsGetValue("streambattle_lanterns", "true") == "true")then
		spawn(g_lamp,x,y+2,0,0)
	end
end

function spawn_props(x, y)
	if(GlobalsGetValue("streambattle_props", "true") == "true")then
...
function create_spawnpoint(x,y)
	EntityLoad("mods/evaisa.streambattle/files/entities/spawn_point.xml", x, y)
end